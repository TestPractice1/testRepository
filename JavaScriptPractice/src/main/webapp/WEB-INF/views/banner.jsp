...
<body>
	...
	<a href="javascript:void(0)" id="prev">이전</a>
        ...
        <div class="rolling_panel">
            <ul>
                <li><img src="<c:url value="/resources/image/a.jpg"/>"></li>
                <li><img src="<c:url value="/resources/image/b.jpg"/>"></li>
                <li><img src="<c:url value="/resources/image/c.jpg"/>"></li>
                <li><img src="<c:url value="/resources/image/d.jpg"/>"></li>
                <li><img src="<c:url value="/resources/image/e.jpg"/>"></li>
            </ul>
        </div>
